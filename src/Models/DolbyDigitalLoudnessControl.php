...
class DolbyDigitalLoudnessControl extends \BitmovinApiSdk\Common\ApiResource
{
    /** @var int */
    public $dialnorm;

    /** @var DolbyDigitalDialogueIntelligence */
    public $dialogueIntelligence;

    /** @var DolbyDigitalLoudnessControlMode */
    public $mode;

    /** @var float */
    public $peakLimit;

    /** @var DolbyDigitalLoudnessControlRegulationType */
    public $regulationType;

    public function __construct($attributes = null)
    {
        parent::__construct($attributes);
        $this->dialogueIntelligence = ObjectMapper::map($this->dialogueIntelligence, DolbyDigitalDialogueIntelligence::class);
        $this->mode = ObjectMapper::map($this->mode, DolbyDigitalLoudnessControlMode::class);
        $this->regulationType = ObjectMapper::map($this->regulationType, DolbyDigitalLoudnessControlRegulationType::class);
    }
     ...
     *
     * @param DolbyDigitalDialogueIntelligence $dialogueIntelligence
     * @return $this
     */
    public function dialogueIntelligence(DolbyDigitalDialogueIntelligence $dialogueIntelligence)
    {
     ...
     * mode
     *
     * @param DolbyDigitalLoudnessControlMode $mode
     * @return $this
     */
    public function mode(DolbyDigitalLoudnessControlMode $mode)
    {
        $this->mode = $mode;
     ...
     *
     * @param DolbyDigitalLoudnessControlRegulationType $regulationType
     * @return $this
     */
    public function regulationType(DolbyDigitalLoudnessControlRegulationType $regulationType)
    {
