...
class DolbyDigitalPlusBitstreamInfo extends \BitmovinApiSdk\Common\ApiResource
{
    /** @var DolbyDigitalPlusSurroundMode */
    public $surroundMode;
    ...
    public function __construct($attributes = null)
    {
        ...
        $this->surroundMode = ObjectMapper::map($this->surroundMode, DolbyDigitalPlusSurroundMode::class);
        $this->surroundExMode = ObjectMapper::map($this->surroundExMode, DolbyDigitalPlusSurroundMode::class);
    }
     ...
     *
     * @param DolbyDigitalPlusSurroundMode $surroundMode
     * @return $this
     */
    public function surroundMode(DolbyDigitalPlusSurroundMode $surroundMode)
    {
     ...
     *
     * @param DolbyDigitalPlusSurroundMode $surroundExMode
     * @return $this
     */
    public function surroundExMode(DolbyDigitalPlusSurroundMode $surroundExMode)
    {
