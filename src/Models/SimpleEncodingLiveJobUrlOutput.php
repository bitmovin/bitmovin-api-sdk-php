...
class SimpleEncodingLiveJobUrlOutput extends \BitmovinApiSdk\Common\ApiResource
{
    /** @var string */
    public $url;

    /** @var SimpleEncodingLiveJobCredentials */
    public $credentials;
    ...
    public function __construct($attributes = null)
    {
        ...
        $this->credentials = ObjectMapper::map($this->credentials, SimpleEncodingLiveJobCredentials::class);
     ...
     *
     * @param SimpleEncodingLiveJobCredentials $credentials
     * @return $this
     */
    public function credentials(SimpleEncodingLiveJobCredentials $credentials)
    {
