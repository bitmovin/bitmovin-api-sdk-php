...
namespace BitmovinApiSdk\Apis\Agents\Assistant\Sessions;
...
class SessionsApi
{
    ...
    {
        $response = $this->httpWrapper->request('POST', '/agents/assistant/sessions', [],  null, null, true);
    ...
    public function delete(string $sessionId) : \BitmovinApiSdk\Models\AgentSessionResponse
    {
        ...
        $response = $this->httpWrapper->request('DELETE', '/agents/assistant/sessions/{session_id}', $pathParams,  null, null, true);
    ...
    public function get(string $sessionId) : \BitmovinApiSdk\Models\AgentSessionHistoryResponse
    {
        ...
        $response = $this->httpWrapper->request('GET', '/agents/assistant/sessions/{session_id}', $pathParams,  null, null, true);
    ...
    {
        $response = $this->httpWrapper->request('GET', '/agents/assistant/sessions', [],  null, null, true);
