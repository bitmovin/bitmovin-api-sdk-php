...
namespace BitmovinApiSdk\Apis\Encoding\Inputs\Gcs\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $inputId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET','/encoding/inputs/gcs/{input_id}/customData', $pathParams,  null, null, true);
