...
namespace BitmovinApiSdk\Apis\Encoding\Inputs\AkamaiNetstorage\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $inputId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET','/encoding/inputs/akamai-netstorage/{input_id}/customData', $pathParams,  null, null, true);
