...
namespace BitmovinApiSdk\Apis\Encoding\Inputs\Zixi\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $inputId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/inputs/zixi/{input_id}/customData', $pathParams,  null, null, true);
