...
namespace BitmovinApiSdk\Apis\Encoding\Inputs\DirectFileUpload\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $inputId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/inputs/direct-file-upload/{input_id}/customData', $pathParams,  null, null, true);
