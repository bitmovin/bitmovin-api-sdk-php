...
namespace BitmovinApiSdk\Apis\Encoding\Inputs\GenericS3\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $inputId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/inputs/generic-s3/{input_id}/customData', $pathParams,  null, null, true);
