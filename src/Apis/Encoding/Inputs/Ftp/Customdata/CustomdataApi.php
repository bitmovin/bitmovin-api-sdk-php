...
namespace BitmovinApiSdk\Apis\Encoding\Inputs\Ftp\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $inputId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/inputs/ftp/{input_id}/customData', $pathParams,  null, null, true);
