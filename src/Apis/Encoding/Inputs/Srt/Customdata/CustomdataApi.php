...
namespace BitmovinApiSdk\Apis\Encoding\Inputs\Srt\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $inputId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/inputs/srt/{input_id}/customData', $pathParams,  null, null, true);
