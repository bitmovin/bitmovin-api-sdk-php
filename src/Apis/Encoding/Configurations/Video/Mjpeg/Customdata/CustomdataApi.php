...
namespace BitmovinApiSdk\Apis\Encoding\Configurations\Video\Mjpeg\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $configurationId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/configurations/video/mjpeg/{configuration_id}/customData', $pathParams,  null, null, true);
