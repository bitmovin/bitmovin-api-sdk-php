...
namespace BitmovinApiSdk\Apis\Encoding\Configurations\Video\Vp8\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $configurationId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET','/encoding/configurations/video/vp8/{configuration_id}/customData', $pathParams,  null, null, true);
