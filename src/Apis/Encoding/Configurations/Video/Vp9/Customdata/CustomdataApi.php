...
namespace BitmovinApiSdk\Apis\Encoding\Configurations\Video\Vp9\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $configurationId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/configurations/video/vp9/{configuration_id}/customData', $pathParams,  null, null, true);
