...
namespace BitmovinApiSdk\Apis\Encoding\Configurations\Video\H265\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $configurationId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/configurations/video/h265/{configuration_id}/customData', $pathParams,  null, null, true);
