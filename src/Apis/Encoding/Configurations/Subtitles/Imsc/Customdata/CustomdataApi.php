...
namespace BitmovinApiSdk\Apis\Encoding\Configurations\Subtitles\Imsc\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $configurationId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/configurations/subtitles/imsc/{configuration_id}/customData', $pathParams,  null, null, true);
