...
namespace BitmovinApiSdk\Apis\Encoding\Configurations\Audio\DolbyAtmos\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $configurationId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/configurations/audio/dolby-atmos/{configuration_id}/customData', $pathParams,  null, null, true);
