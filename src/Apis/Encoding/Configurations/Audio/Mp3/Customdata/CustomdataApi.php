...
namespace BitmovinApiSdk\Apis\Encoding\Configurations\Audio\Mp3\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $configurationId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/configurations/audio/mp3/{configuration_id}/customData', $pathParams,  null, null, true);
