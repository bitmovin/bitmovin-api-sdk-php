...
namespace BitmovinApiSdk\Apis\Encoding\Configurations\Audio\HeAacV1\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $configurationId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/configurations/audio/he-aac-v1/{configuration_id}/customData', $pathParams,  null, null, true);
