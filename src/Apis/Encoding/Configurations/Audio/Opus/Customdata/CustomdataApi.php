...
namespace BitmovinApiSdk\Apis\Encoding\Configurations\Audio\Opus\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $configurationId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/configurations/audio/opus/{configuration_id}/customData', $pathParams,  null, null, true);
