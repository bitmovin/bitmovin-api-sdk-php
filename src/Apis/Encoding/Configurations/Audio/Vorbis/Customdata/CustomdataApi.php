...
namespace BitmovinApiSdk\Apis\Encoding\Configurations\Audio\Vorbis\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $configurationId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/configurations/audio/vorbis/{configuration_id}/customData', $pathParams,  null, null, true);
