...
namespace BitmovinApiSdk\Apis\Encoding\Filters\Deinterlace\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $filterId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET','/encoding/filters/deinterlace/{filter_id}/customData', $pathParams,  null, null, true);
