...
namespace BitmovinApiSdk\Apis\Encoding\Filters\EnhancedWatermark\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $filterId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET','/encoding/filters/enhanced-watermark/{filter_id}/customData', $pathParams,  null, null, true);
