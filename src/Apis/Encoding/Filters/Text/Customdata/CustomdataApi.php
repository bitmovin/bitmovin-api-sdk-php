...
namespace BitmovinApiSdk\Apis\Encoding\Filters\Text\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $filterId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET','/encoding/filters/text/{filter_id}/customData', $pathParams,  null, null, true);
