...
namespace BitmovinApiSdk\Apis\Encoding\Filters\EnhancedDeinterlace\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $filterId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/filters/enhanced-deinterlace/{filter_id}/customData', $pathParams,  null, null, true);
