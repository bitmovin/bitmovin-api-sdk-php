...
namespace BitmovinApiSdk\Apis\Encoding\Filters\AudioVolume\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $filterId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/filters/audio-volume/{filter_id}/customData', $pathParams,  null, null, true);
