...
namespace BitmovinApiSdk\Apis\Encoding\Filters\AzureSpeechToCaptions\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $filterId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/filters/azure-speech-to-captions/{filter_id}/customData', $pathParams,  null, null, true);
