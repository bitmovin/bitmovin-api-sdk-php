...
namespace BitmovinApiSdk\Apis\Encoding\Filters\AudioMix\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $filterId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/filters/audio-mix/{filter_id}/customData', $pathParams,  null, null, true);
