...
namespace BitmovinApiSdk\Apis\Encoding\Filters\DolbyLoudness\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $filterId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/filters/dolby-loudness/{filter_id}/customData', $pathParams,  null, null, true);
