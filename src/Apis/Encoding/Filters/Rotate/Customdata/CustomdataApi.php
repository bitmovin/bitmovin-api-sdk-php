...
namespace BitmovinApiSdk\Apis\Encoding\Filters\Rotate\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $filterId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET','/encoding/filters/rotate/{filter_id}/customData', $pathParams,  null, null, true);
