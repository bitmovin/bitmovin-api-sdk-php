...
namespace BitmovinApiSdk\Apis\Encoding\Filters\Crop\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $filterId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET','/encoding/filters/crop/{filter_id}/customData', $pathParams,  null, null, true);
