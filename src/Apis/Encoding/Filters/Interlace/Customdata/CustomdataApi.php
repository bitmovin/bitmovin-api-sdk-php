...
namespace BitmovinApiSdk\Apis\Encoding\Filters\Interlace\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $filterId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/filters/interlace/{filter_id}/customData', $pathParams,  null, null, true);
