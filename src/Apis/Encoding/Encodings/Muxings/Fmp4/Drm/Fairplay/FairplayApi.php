...
use BitmovinApiSdk\Apis\Encoding\Encodings\Muxings\Fmp4\Drm\Fairplay\Customdata\CustomdataApi;
...
class FairplayApi
{
    ...
    public function create(string $encodingId, string $muxingId, \BitmovinApiSdk\Models\FairPlayDrm $fairPlayDrm) : \BitmovinApiSdk\Models\FairPlayDrm
    {
        ...
        $response = $this->httpWrapper->request('POST','/encoding/encodings/{encoding_id}/muxings/fmp4/{muxing_id}/drm/fairplay', $pathParams,  null, $fairPlayDrm, true);
    ...
    public function delete(string $encodingId, string $muxingId, string $drmId) : \BitmovinApiSdk\Models\BitmovinResponse
    {
        ...
        $response = $this->httpWrapper->request('DELETE','/encoding/encodings/{encoding_id}/muxings/fmp4/{muxing_id}/drm/fairplay/{drm_id}', $pathParams,  null, null, true);
    ...
    public function get(string $encodingId, string $muxingId, string $drmId) : \BitmovinApiSdk\Models\FairPlayDrm
    {
        ...
        $response = $this->httpWrapper->request('GET','/encoding/encodings/{encoding_id}/muxings/fmp4/{muxing_id}/drm/fairplay/{drm_id}', $pathParams,  null, null, true);
    ...
    public function list(string $encodingId, string $muxingId, FairPlayDrmListQueryParams $queryParams = null) : FairPlayDrmPaginationResponse
    {
        ...
        $response = $this->httpWrapper->request('GET','/encoding/encodings/{encoding_id}/muxings/fmp4/{muxing_id}/drm/fairplay', $pathParams, $queryParams, null, true);
