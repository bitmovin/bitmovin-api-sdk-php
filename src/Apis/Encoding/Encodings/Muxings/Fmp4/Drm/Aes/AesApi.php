...
use BitmovinApiSdk\Apis\Encoding\Encodings\Muxings\Fmp4\Drm\Aes\Customdata\CustomdataApi;
...
class AesApi
{
    ...
    public function create(string $encodingId, string $muxingId, \BitmovinApiSdk\Models\AesEncryptionDrm $aesEncryptionDrm) : \BitmovinApiSdk\Models\AesEncryptionDrm
    {
        ...
        $response = $this->httpWrapper->request('POST', '/encoding/encodings/{encoding_id}/muxings/fmp4/{muxing_id}/drm/aes', $pathParams,  null, $aesEncryptionDrm, true);
    ...
    public function delete(string $encodingId, string $muxingId, string $drmId) : \BitmovinApiSdk\Models\BitmovinResponse
    {
        ...
        $response = $this->httpWrapper->request('DELETE', '/encoding/encodings/{encoding_id}/muxings/fmp4/{muxing_id}/drm/aes/{drm_id}', $pathParams,  null, null, true);
    ...
    public function get(string $encodingId, string $muxingId, string $drmId) : \BitmovinApiSdk\Models\AesEncryptionDrm
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/encodings/{encoding_id}/muxings/fmp4/{muxing_id}/drm/aes/{drm_id}', $pathParams,  null, null, true);
    ...
    public function list(string $encodingId, string $muxingId, AesEncryptionDrmListQueryParams $queryParams = null) : AesEncryptionDrmPaginationResponse
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/encodings/{encoding_id}/muxings/fmp4/{muxing_id}/drm/aes', $pathParams, $queryParams, null, true);
