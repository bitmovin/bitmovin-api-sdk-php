...
namespace BitmovinApiSdk\Apis\Encoding\Encodings\Muxings\Ts\Drm\Fairplay\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $encodingId, string $muxingId, string $drmId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET','/encoding/encodings/{encoding_id}/muxings/ts/{muxing_id}/drm/fairplay/{drm_id}/customData', $pathParams,  null, null, true);
