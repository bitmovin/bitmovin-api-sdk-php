...
use BitmovinApiSdk\Apis\Encoding\Encodings\Muxings\ProgressiveWebm\Drm\Speke\Customdata\CustomdataApi;
...
class SpekeApi
{
    ...
    public function create(string $encodingId, string $muxingId, \BitmovinApiSdk\Models\SpekeDrm $spekeDrm) : \BitmovinApiSdk\Models\SpekeDrm
    {
        ...
        $response = $this->httpWrapper->request('POST','/encoding/encodings/{encoding_id}/muxings/progressive-webm/{muxing_id}/drm/speke', $pathParams,  null, $spekeDrm, true);
    ...
    public function delete(string $encodingId, string $muxingId, string $drmId) : \BitmovinApiSdk\Models\BitmovinResponse
    {
        ...
        $response = $this->httpWrapper->request('DELETE','/encoding/encodings/{encoding_id}/muxings/progressive-webm/{muxing_id}/drm/speke/{drm_id}', $pathParams,  null, null, true);
    ...
    public function get(string $encodingId, string $muxingId, string $drmId) : \BitmovinApiSdk\Models\SpekeDrm
    {
        ...
        $response = $this->httpWrapper->request('GET','/encoding/encodings/{encoding_id}/muxings/progressive-webm/{muxing_id}/drm/speke/{drm_id}', $pathParams,  null, null, true);
    ...
    public function list(string $encodingId, string $muxingId, SpekeDrmListQueryParams $queryParams = null) : SpekeDrmPaginationResponse
    {
        ...
        $response = $this->httpWrapper->request('GET','/encoding/encodings/{encoding_id}/muxings/progressive-webm/{muxing_id}/drm/speke', $pathParams, $queryParams, null, true);
