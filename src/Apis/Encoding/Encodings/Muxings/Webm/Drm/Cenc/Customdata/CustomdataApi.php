...
namespace BitmovinApiSdk\Apis\Encoding\Encodings\Muxings\Webm\Drm\Cenc\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $encodingId, string $muxingId, string $drmId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/encodings/{encoding_id}/muxings/webm/{muxing_id}/drm/cenc/{drm_id}/customData', $pathParams,  null, null, true);
