...
use BitmovinApiSdk\Apis\Encoding\Encodings\Muxings\Mp4\Drm\Cenc\Customdata\CustomdataApi;
...
class CencApi
{
    ...
    public function create(string $encodingId, string $muxingId, \BitmovinApiSdk\Models\CencDrm $cencDrm) : \BitmovinApiSdk\Models\CencDrm
    {
        ...
        $response = $this->httpWrapper->request('POST', '/encoding/encodings/{encoding_id}/muxings/mp4/{muxing_id}/drm/cenc', $pathParams,  null, $cencDrm, true);
    ...
    public function delete(string $encodingId, string $muxingId, string $drmId) : \BitmovinApiSdk\Models\BitmovinResponse
    {
        ...
        $response = $this->httpWrapper->request('DELETE', '/encoding/encodings/{encoding_id}/muxings/mp4/{muxing_id}/drm/cenc/{drm_id}', $pathParams,  null, null, true);
    ...
    public function get(string $encodingId, string $muxingId, string $drmId) : \BitmovinApiSdk\Models\CencDrm
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/encodings/{encoding_id}/muxings/mp4/{muxing_id}/drm/cenc/{drm_id}', $pathParams,  null, null, true);
    ...
    public function list(string $encodingId, string $muxingId, CencDrmListQueryParams $queryParams = null) : CencDrmPaginationResponse
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/encodings/{encoding_id}/muxings/mp4/{muxing_id}/drm/cenc', $pathParams, $queryParams, null, true);
