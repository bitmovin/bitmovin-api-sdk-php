...
namespace BitmovinApiSdk\Apis\Encoding\Encodings\Muxings\Mp4\Drm\Marlin\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $encodingId, string $muxingId, string $drmId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/encodings/{encoding_id}/muxings/mp4/{muxing_id}/drm/marlin/{drm_id}/customData', $pathParams,  null, null, true);
