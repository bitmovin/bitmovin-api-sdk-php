...
namespace BitmovinApiSdk\Apis\Encoding\Encodings\Muxings\Mp4\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $encodingId, string $muxingId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET','/encoding/encodings/{encoding_id}/muxings/mp4/{muxing_id}/customData', $pathParams,  null, null, true);
