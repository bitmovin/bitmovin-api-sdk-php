...
namespace BitmovinApiSdk\Apis\Encoding\Encodings\Muxings\Cmaf\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $encodingId, string $muxingId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/customData', $pathParams,  null, null, true);
