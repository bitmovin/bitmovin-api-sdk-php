...
namespace BitmovinApiSdk\Apis\Encoding\Encodings\Muxings\ProgressiveTs\Id3\PlainText\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $encodingId, string $muxingId, string $id3TagId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET','/encoding/encodings/{encoding_id}/muxings/progressive-ts/{muxing_id}/id3/plain-text/{id3_tag_id}/customData', $pathParams,  null, null, true);
