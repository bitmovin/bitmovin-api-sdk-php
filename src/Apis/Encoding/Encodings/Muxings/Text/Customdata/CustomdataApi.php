...
namespace BitmovinApiSdk\Apis\Encoding\Encodings\Muxings\Text\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $encodingId, string $muxingId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/encodings/{encoding_id}/muxings/text/{muxing_id}/customData', $pathParams,  null, null, true);
