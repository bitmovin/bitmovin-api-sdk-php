...
namespace BitmovinApiSdk\Apis\Encoding\Encodings\Streams\Captions\Cea\Scc\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $encodingId, string $streamId, string $captionsId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET','/encoding/encodings/{encoding_id}/streams/{stream_id}/captions/608-708/scc/{captions_id}/customData', $pathParams,  null, null, true);
