...
namespace BitmovinApiSdk\Apis\Encoding\Outputs\GcsServiceAccount\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $outputId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/outputs/gcs-service-account/{output_id}/customData', $pathParams,  null, null, true);
