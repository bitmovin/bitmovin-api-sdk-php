...
namespace BitmovinApiSdk\Apis\Encoding\Outputs\LiveMediaIngest\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $outputId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET','/encoding/outputs/live-media-ingest/{output_id}/customData', $pathParams,  null, null, true);
