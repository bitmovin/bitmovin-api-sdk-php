...
namespace BitmovinApiSdk\Apis\Encoding\Outputs\Azure\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $outputId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET','/encoding/outputs/azure/{output_id}/customData', $pathParams,  null, null, true);
