...
namespace BitmovinApiSdk\Apis\Encoding\Outputs\Gcs\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $outputId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/outputs/gcs/{output_id}/customData', $pathParams,  null, null, true);
