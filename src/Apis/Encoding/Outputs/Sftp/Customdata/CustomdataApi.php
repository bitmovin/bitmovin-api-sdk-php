...
namespace BitmovinApiSdk\Apis\Encoding\Outputs\Sftp\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $outputId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/outputs/sftp/{output_id}/customData', $pathParams,  null, null, true);
