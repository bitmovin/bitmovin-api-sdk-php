...
namespace BitmovinApiSdk\Apis\Encoding\Outputs\AkamaiMsl\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $outputId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET','/encoding/outputs/akamai-msl/{output_id}/customData', $pathParams,  null, null, true);
