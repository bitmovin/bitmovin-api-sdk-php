...
namespace BitmovinApiSdk\Apis\Encoding\Outputs\GenericS3\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $outputId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/outputs/generic-s3/{output_id}/customData', $pathParams,  null, null, true);
