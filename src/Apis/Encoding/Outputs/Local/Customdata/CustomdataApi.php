...
namespace BitmovinApiSdk\Apis\Encoding\Outputs\Local\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $outputId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET','/encoding/outputs/local/{output_id}/customData', $pathParams,  null, null, true);
