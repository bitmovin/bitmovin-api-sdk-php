...
namespace BitmovinApiSdk\Apis\Encoding\Outputs\AkamaiNetstorage\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $outputId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/outputs/akamai-netstorage/{output_id}/customData', $pathParams,  null, null, true);
