...
namespace BitmovinApiSdk\Apis\Encoding\Manifests\Dash\Periods\Adaptationsets\Representations\Fmp4\Contentprotection;
...
class ContentprotectionApi
{
    ...
    public function create(string $manifestId, string $periodId, string $adaptationsetId, string $representationId, \BitmovinApiSdk\Models\ContentProtection $contentProtection) : \BitmovinApiSdk\Models\ContentProtection
    {
        ...
        $response = $this->httpWrapper->request('POST', '/encoding/manifests/dash/{manifest_id}/periods/{period_id}/adaptationsets/{adaptationset_id}/representations/fmp4/{representation_id}/contentprotection', $pathParams,  null, $contentProtection, true);
    ...
    public function delete(string $manifestId, string $periodId, string $adaptationsetId, string $representationId, string $contentprotectionId) : \BitmovinApiSdk\Models\BitmovinResponse
    {
        ...
        $response = $this->httpWrapper->request('DELETE', '/encoding/manifests/dash/{manifest_id}/periods/{period_id}/adaptationsets/{adaptationset_id}/representations/fmp4/{representation_id}/contentprotection/{contentprotection_id}', $pathParams,  null, null, true);
    ...
    public function get(string $manifestId, string $periodId, string $adaptationsetId, string $representationId, string $contentprotectionId) : \BitmovinApiSdk\Models\ContentProtection
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/manifests/dash/{manifest_id}/periods/{period_id}/adaptationsets/{adaptationset_id}/representations/fmp4/{representation_id}/contentprotection/{contentprotection_id}', $pathParams,  null, null, true);
    ...
    public function list(string $manifestId, string $periodId, string $adaptationsetId, string $representationId, ContentProtectionListQueryParams $queryParams = null) : ContentProtectionPaginationResponse
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/manifests/dash/{manifest_id}/periods/{period_id}/adaptationsets/{adaptationset_id}/representations/fmp4/{representation_id}/contentprotection', $pathParams, $queryParams, null, true);
