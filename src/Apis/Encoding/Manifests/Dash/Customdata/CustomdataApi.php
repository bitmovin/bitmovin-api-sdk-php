...
namespace BitmovinApiSdk\Apis\Encoding\Manifests\Dash\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $manifestId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET','/encoding/manifests/dash/{manifest_id}/customData', $pathParams,  null, null, true);
