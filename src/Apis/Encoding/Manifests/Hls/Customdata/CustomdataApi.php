...
namespace BitmovinApiSdk\Apis\Encoding\Manifests\Hls\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $manifestId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET', '/encoding/manifests/hls/{manifest_id}/customData', $pathParams,  null, null, true);
