...
namespace BitmovinApiSdk\Apis\Analytics\Outputs\Azure\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $outputId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET', '/analytics/outputs/azure/{output_id}/customData', $pathParams,  null, null, true);
