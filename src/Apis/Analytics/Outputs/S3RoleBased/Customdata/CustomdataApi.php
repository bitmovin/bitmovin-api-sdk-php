...
namespace BitmovinApiSdk\Apis\Analytics\Outputs\S3RoleBased\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $outputId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET','/analytics/outputs/s3-role-based/{output_id}/customData', $pathParams,  null, null, true);
