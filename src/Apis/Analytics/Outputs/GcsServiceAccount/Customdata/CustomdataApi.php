...
namespace BitmovinApiSdk\Apis\Analytics\Outputs\GcsServiceAccount\Customdata;
...
class CustomdataApi
{
    ...
    public function get(string $outputId) : \BitmovinApiSdk\Models\CustomData
    {
        ...
        $response = $this->httpWrapper->request('GET', '/analytics/outputs/gcs-service-account/{output_id}/customData', $pathParams,  null, null, true);
