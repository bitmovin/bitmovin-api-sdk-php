...
namespace BitmovinApiSdk\Apis\Notifications\Webhooks\Encoding\Encodings\LiveManifestReady;
...
use BitmovinApiSdk\Apis\Notifications\Webhooks\Encoding\Encodings\LiveManifestReady\Customdata\CustomdataApi;
...
class LiveManifestReadyApi
{
    ...
    /**
     * LiveManifestReadyApi constructor.
     *
    ...
    {
        $response = $this->httpWrapper->request('POST', '/notifications/webhooks/encoding/encodings/live-manifest-ready', [],  null, $webhook, true);
    ...
    public function createByEncodingId(string $encodingId, \BitmovinApiSdk\Models\Webhook $webhook) : \BitmovinApiSdk\Models\Webhook
    {
        ...
        $response = $this->httpWrapper->request('POST', '/notifications/webhooks/encoding/encodings/{encoding_id}/live-manifest-ready', $pathParams,  null, $webhook, true);
    ...
    public function deleteByEncodingIdAndWebhookId(string $encodingId, string $webhookId) : \BitmovinApiSdk\Models\BitmovinResponse
    {
        ...
        $response = $this->httpWrapper->request('DELETE', '/notifications/webhooks/encoding/encodings/{encoding_id}/live-manifest-ready/{webhook_id}', $pathParams,  null, null, true);
    ...
    public function deleteByWebhookId(string $webhookId) : \BitmovinApiSdk\Models\BitmovinResponse
    {
        ...
        $response = $this->httpWrapper->request('DELETE', '/notifications/webhooks/encoding/encodings/live-manifest-ready/{webhook_id}', $pathParams,  null, null, true);
    ...
    public function getByEncodingIdAndWebhookId(string $encodingId, string $webhookId) : \BitmovinApiSdk\Models\Webhook
    {
        ...
        $response = $this->httpWrapper->request('GET', '/notifications/webhooks/encoding/encodings/{encoding_id}/live-manifest-ready/{webhook_id}', $pathParams,  null, null, true);
    ...
    public function getByWebhookId(string $webhookId) : \BitmovinApiSdk\Models\Webhook
    {
        ...
        $response = $this->httpWrapper->request('GET', '/notifications/webhooks/encoding/encodings/live-manifest-ready/{webhook_id}', $pathParams,  null, null, true);
    ...
    {
        $response = $this->httpWrapper->request('GET', '/notifications/webhooks/encoding/encodings/live-manifest-ready', [], $queryParams, null, true);
    ...
    public function listByEncodingId(string $encodingId, WebhookListByEncodingIdQueryParams $queryParams = null) : WebhookPaginationResponse
    {
        ...
        $response = $this->httpWrapper->request('GET', '/notifications/webhooks/encoding/encodings/{encoding_id}/live-manifest-ready', $pathParams, $queryParams, null, true);
